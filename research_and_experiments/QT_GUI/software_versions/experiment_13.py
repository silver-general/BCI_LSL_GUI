...
from PySide6.QtCore import QStandardPaths, Qt, QSize, QRunnable, Slot, QThreadPool
...
class ApproveExperimentWindow(QWidget):
    ...
    def __init__(self):
        ...
        """ setup thread pool for running mediaplayer and signal recording """
...
class MainWindow(QMainWindow):
    ...
    def generate_MI_sequence(self):
        ...
        playlist_info = { "sequence" : sequence }

        for stimulus in stimuli_list:
            playlist_info[ "stimulus {}".format(stimulus.stimulus_number) ] = stimulus.description
...
import time # just to play around
class ExperimentRun():

    def __init__(self, playlist_info, stream_info, project_folder):
        ...
        print("initialising ExperimentRun object")
        print("playlist info: {}".format(self.playlist_info))
        print("streaminfo: {}".format(self.stream_info))
        print("project folder: {}".format(self.project_folder))
    ...
    def run_experiment(self):
        ...
        print( f"Experiment starts at: {self.start_time}")


        self.thread_pool.start(self.thread1)
        self.thread_pool.start(self.thread2)

    def terminate_and_save(self, message):
    ...
    def thread1(self):
        ...
        try:
            ...
            print("Failed to Estabilish an inlet. Return to Stream Selection window and reselect outlet!")
        ...
        print("Theoretically needed samples: {}".format( self.stream_info.nominal_srate() * duration ) )
