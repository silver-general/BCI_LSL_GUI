...
def main(name='LSLExampleAmp', stream_type='EEG', srate=100):
    ...
    # location on the scalp? what coordinates???
    channel_locations = [
    ...
    while True:
        ...
        # find out how many samples you should've sent in the elapsed time wigen the sampling rate
        # and required_samples are the ones you're missing
