...
class ExperimentSetupWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.MI_parameters = {} # QUESTION: sshould I even use those? i can directly update the main window metadata!
        ...
        # add a form to upload an audio cue
        # delete this, better keep this into the stimulus widget self.audio_cue_browse_button = QPushButton("Upload audio cue")
...
class StimulusWidget(QWidget):
    ...
    def __init__(self, widget_number):
        ...
        self.grid.addWidget( self.clear_button, 3,4 )
