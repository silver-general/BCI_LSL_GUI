...
class ExperimentSetupWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.settings_form_elements = { "Stimulus duration" : self.stimulus_duration, "Rest time" : self.rest_time, "Runs per stimulus" : self.runs_per_class } # NOTE: items are widgets!
...
class ExperimentRun(QWidget): # QUESTION: WHAT TO USE HERE? MULTITHREADING!
...
class MainWindow(QMainWindow):
    ...
    def generate_MI_sequence(self):
        ...
        self.page3.playlist_info = playlist_info
        """
